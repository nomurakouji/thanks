...
RSpec.describe 'department管理機能', type: :system do
  describe 'departmentのCRUD機能' do
    before do
        ...
        click_on 'ゲスト管理者ログイン'
        # 部門管理をクリック
        find(:xpath,'/html/body/div[2]/div/div/div/a[3]/button').click
    end
    ...
    context 'department編集' do
        it '新規部門名が編集される' do
          ...
          click_on '作成する'
          # 編集ボタンをクリック
          find(:xpath,'/html/body/div[3]/div/table/tbody/tr[1]/td[3]/a').click
    ...
    context 'department削除' do
        it '部門名が削除される' do
          ...
          click_on '作成する'
          # 削除するボタンをクリック
          find(:xpath,'/html/body/div[3]/div/table/tbody/tr[2]/td[4]/form/input[2]').click
          # アラートボタンを押す
